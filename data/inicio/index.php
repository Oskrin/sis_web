                ...
                <div class="body-content animated fadeIn">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-4 col-xs-12">
                                    ...
                                    <div class="widget-wrapper bg-theme rounded">
                                        <div class="weather-current-city">
                                            <img src="../../dist/global/img/building/5.jpg" alt="..."/>
                                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="table-responsive rounded mb-20">
                                <table class="table table-striped table-theme">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../dist/global/img/avatar/35/2.png" class="img-circle img-bordered-theme" alt="John Kribo">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../dist/global/img/avatar/35/3.png" class="img-circle img-bordered-theme" alt="Jennifer Poiyem">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../dist/global/img/avatar/35/4.png" class="img-circle img-bordered-theme" alt="Clara Wati">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../dist/global/img/avatar/35/5.png" class="img-circle img-bordered-theme" alt="Toni Mriang">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="../../dist/global/img/avatar/35/6.png" class="img-circle img-bordered-theme" alt="Bella negoro">
                            ...
                            <!-- Start dropzone js -->
                            <form action="http://128.199.167.219/blankon-fullpack-admin-theme/1.0.5/assets/admin/data" class="dropzone mb-20 rounded">
                                <div class="fallback">
                                    ...
                                    <ul class="sidebar-menu niceScroll">
                                        ...
                                        <li>
                                            <div class="media-list working">
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/10.png" class="img-circle" alt="Daddy Botak">
                                                        <i class="online"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/11.png" class="img-circle" alt="Sarah Tingting">
                                                        <i class="offline"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/26.png" class="img-circle" alt="">
                                                        <i class="busy"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/13.png" class="img-circle" alt="Claudia Cinta">
                                                        <i class="online"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                    ...
                                    <ul class="sidebar-menu niceScroll">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/12.png" class="img-circle" alt="Harry Potret">
                                                        <i class="online"></i>
                                                    </span>
                                                    <span class="media-body">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/15.png" class="img-circle" alt="Jeck Joko">
                                                        <i class="online"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/16.png" class="img-circle" alt="Tenny Imoet">
                                                        <i class="busy"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/17.png" class="img-circle" alt="Leli Madang">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/18.png" class="img-circle" alt="Rebecca Cabean">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/19.png" class="img-circle" alt="Sishy Mawar">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="../../dist/global/img/avatar/35/20.png" class="img-circle" alt="Mbah Roso">
                                                        <i class="away"></i>
                                                    </span>
                                                    <span class="media-body">
...
<!-- Mirrored from 128.199.167.219/blankon-fullpack-admin-theme/1.0.5/production/admin/html/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Apr 2015 15:41:14 GMT -->
</html>